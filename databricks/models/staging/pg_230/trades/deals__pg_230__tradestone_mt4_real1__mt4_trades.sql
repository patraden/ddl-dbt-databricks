{{ config(
        pre_hook="CREATE TABLE if not exists dw.deals__pg_230__tradestone_mt4_real1__mt4_trades USING parquet LOCATION 'gs://staging-databricks-prod/pg_230__deals/tradestone_mt4_real1__mt4_trades/'",
