{{ config(
        pre_hook="CREATE TABLE if not exists dw.deals__pg_230__asic_mt4_demo1__mt4_trades USING parquet LOCATION 'gs://staging-databricks-prod/pg_230__deals/asic_mt4_demo1__mt4_trades/'",
