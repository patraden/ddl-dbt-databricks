{{ config(
        pre_hook="CREATE TABLE if not exists dw.deals__pg_230__fbs_mt4_real3__mt4_users USING parquet LOCATION 'gs://staging-databricks-prod/pg_230__deals/fbs_mt4_real3__mt4_users/'",
...
from {{ source('dw', 'deals__pg_230__fbs_mt4_real3__mt4_users') }}
{% if is_incremental() %}
  -- this filter will only be applied on an incremental run
--  where input_file_name() = 'https://storage.cloud.google.com/staging-databricks-prod/pg_230__deals/fbs_mt4_real3__mt4_users/part-0-1672023636102.gzip.parquet'
--  where input_file_name() = 'https://storage.cloud.google.com/staging-databricks-prod/pg_230__deals/fbs_mt4_real3__mt4_users/part-0-1672066834973.gzip.parquet'
--  where input_file_name() = 'https://storage.cloud.google.com/staging-databricks-prod/pg_230__deals/fbs_mt4_real3__mt4_users/part-0-1672110072818.gzip.parquet'
{% endif %}
