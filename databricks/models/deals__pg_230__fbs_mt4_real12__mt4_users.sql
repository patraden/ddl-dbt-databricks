{{ config(
        pre_hook="CREATE TABLE if not exists dw.deals__pg_230__fbs_mt4_real12__mt4_users USING parquet LOCATION 'gs://staging-databricks-test/pg_230__deals/fbs_mt4_real12__mt4_users'",
