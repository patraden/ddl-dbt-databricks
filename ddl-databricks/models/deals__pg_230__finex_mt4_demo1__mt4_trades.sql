{{ config(
        pre_hook="CREATE TABLE if not exists dw.deals__pg_230__finex_mt4_demo1__mt4_trades USING parquet LOCATION 'gs://staging-databricks-prod/pg_230__deals/finex_mt4_demo1__mt4_trades/'",
