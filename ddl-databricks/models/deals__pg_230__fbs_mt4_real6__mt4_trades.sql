{{ config(
        pre_hook="CREATE TABLE if not exists dw.deals__pg_230__fbs_mt4_real6__mt4_trades USING parquet LOCATION 'gs://staging-databricks-test/pg_230__deals/fbs_mt4_real6__mt4_trades'",
