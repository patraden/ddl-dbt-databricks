{{ config(
        pre_hook="CREATE TABLE if not exists dw.deals__pg_230__fbs_mt4_real5__mt4_users USING parquet LOCATION 'gs://staging-databricks-prod/pg_230__deals/fbs_mt4_real5__mt4_users/'",
...
from {{ source('dw', 'deals__pg_230__fbs_mt4_real5__mt4_users') }}
{% if is_incremental() %}
  -- this filter will only be applied on an incremental run
--  where input_file_name() = 'gs://staging-databricks-prod/pg_230__deals/fbs_mt4_real5__mt4_users/part-0-1672023668123.gzip.parquet'
--  where input_file_name() = 'gs://staging-databricks-prod/pg_230__deals/fbs_mt4_real5__mt4_users/part-0-1672066835304.gzip.parquet'
  where input_file_name() = 'gs://staging-databricks-prod/pg_230__deals/fbs_mt4_real5__mt4_users/part-0-1672110083139.gzip.parquet'
{% endif %}
